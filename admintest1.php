  ...
  <div class="column1">
	<h3 id="green">Insert New URL</h3>
		<form name="frm_insert" action="<? echo $_SERVER['PHP_SELF'] ?>" method="post">
			...
			<label>Short Name<br /><input type="text" name="insert_shortname" value="" class="input-text"></label>
				<br />
			<label>URL<br /><input type="text" name="insert_url" value="" class="input-text"></label>
				<br />
			<label>Owner Email<br /><input type="text" name="insert_owneremail" value="" class="input-text"></label>
				<br />
			<?
				hidden_elements('insert', $current);
			?>
			<br />
                        <input type="submit" value="Insert" class="input-button">
		</form>
  </div>
</div>
<div class="row">
